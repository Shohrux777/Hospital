      ...
      <div class="bg-white p-4 mb-5 pt-4 shadow" style="border-radius:5px; position:relative;">
        ...
        <div class="TablePatientDocId p-3">
          <table class="myTable">
            ...
            <tbody>
              <tr v-for="(row,rowIndex) in get_report_by_data_contragent.rows" :key="rowIndex">
              ...
              <tr >
                ...
                <td> <span ></span> </td>
                <td> <span class="text-primary">{{get_report_qty_summ.qty}}</span></td>
                <td> <span class="text-danger">{{get_report_qty_summ.summ}}</span> </td>
                <td> <span ></span> </td>
                <td></td>
                <td></td>
              </tr>
              ...
              <table class="myTable">
                ...
                <tbody>
                  ...
                  <tr >
                    ...
                    <td> <span ></span> </td>
                    <td> <span ></span>{{get_report_qty_summ.qty}}</td>
                    <td> <span >{{get_report_qty_summ.summ}}</span> </td>
                    <td> <span ></span> </td>
                    <td></td>
                    <td></td>
                  </tr>
...
<script>
  ...
  export default {
    components: {
      mdbBtn,
      mdbModal, mdbModalHeader, mdbModalTitle, mdbModalBody, lineSelect, DatePicker,
    ...
    computed: mapGetters(['get_contragent_list', 'get_report_by_data_contragent', 'get_report_qty_summ']),
    methods: {
