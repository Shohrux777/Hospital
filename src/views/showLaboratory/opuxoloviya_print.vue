    ...
    <div class="rv_lab allWidthLab" id="table" style="position:relative;">
      ...
      <div class="lab_answer upHeight" >
        <div class=" " style="display:flex; justify-content:center; flex-direction:column;">
          <h3 style="width:100%; text-align:center; font-weight: bold;" class="mb-5 headerTitle">ОПУХОЛЕВЫЕ МАРКЕРЫ</h3>
          ...
          <table border class="allWidthLabTable" style="margin-top:35px;">
            <thead>
              <tr>
                <th class="fs"  style="width:45%;"><span class="font-weight-bold ">Вид анализа </span></th>
            ...
            <tbody>
              <tr>
                <td class="fs"  style="width:45%;">СА-125 </td>
                <td class="fs"  style="width:45%;">{{option.name_1}}</td>
                <td class="fs" >0-35 Ед/мл  </td>
              </tr>
