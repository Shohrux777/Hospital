  ...
  <div>
    <div class="rv_lab allWidthLab" id="table" style="position:relative;">
      ...
      <div class="lab_answer upHeight" >
        <div class=" " style="display:flex; justify-content:center; flex-direction:column;">
          <h3 style="width:100%; text-align:center; font-weight: bold;" class="mb-5 headerTitle">ВРЕМЯ СВЕРТЫВАНИЯ</h3>
          ...
          <table border class="allWidthLabTable" style="margin-top:35px;">
            <thead>
              <tr>
                <th class="fs"  style="width:45%;"><span class="font-weight-bold ">Результат</span></th>
                <th class="fs" ><span class="font-weight-bold py-2">Норма</span></th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td class="fs"  style="width:45%;">H: {{option.h}}</td>
                <td class="fs" >Н: 20 с -3 мин  </td>
              </tr>
              <tr>
                <td class="fs"  style="width:45%;">K: {{option.k}}</td>
                <td class="fs" >К: 3 мин -5 мин </td>
              </tr>
            </tbody>
          </table>
        </div>
    ...
    <div class="d-flex justify-content-center">
      <div style="width:83%; text-align:right; position:fixed; bottom:10px; right:108px;" v-if="font_size == false">
        <mdb-btn v-if="false" color="success px-4 py-1" style="font-size:15px;" type="submit" @click="printed"><mdb-icon icon="print" /></mdb-btn>
