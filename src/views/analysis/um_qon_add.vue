   ...
   <loader v-if="loading"/>
    <div v-else class="mx-1 row">
      <div class="col-4" >
        ...
        <div style="position:relative;">
          <mdb-input :label="('Нейтрофилы')"  v-model="neytrofili" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Эозинофилы')"  v-model="eozinofili" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Лимфоциты')"  v-model="limfotsi_2" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Моноциты')"  v-model="monofisitsi_2" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Эозинофилы')"  v-model="eozinofili_2" outline/>
      ...
      <div class="col-4" >
        <div style="position:relative;">
          <mdb-input :label="('Базофилы')"  v-model="bazofili_2" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Гемоглобин')"  v-model="gemoglabin" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Гемотокрит')"  v-model="gemotokrit" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Ср.обьём эр. ')"  v-model="sr_obyom_er" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Ср.сод.гем.в эр.')"  v-model="sr_sod_gem_er" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Ср.конц.гем.в эр.')"  v-model="sr_kons_gem_er" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Шир.расп.гем.в эр.')"  v-model="shir_ras_er_gem" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Шир.расп.эр.по объёму')"  v-model="shir_ras_er_po_obyom" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Тромбоциты')"  v-model="trobositi" outline/>
      ...
      <div class="col-4" >
        ...
        <div style="position:relative;">
          <mdb-input :label="('Средний обьём тромбоцитов')"  v-model="sredniy_obyom_trombositov" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Шир.расп.тромб.по объёму')"  v-model="shir_rasm_tromb_po_obyom" outline/>
          <small v-if="$v.shir_rasm_tromb_po_obyom.$dirty  && !$v.shir_rasm_tromb_po_obyom.required" class="invalid-text  pl-4" style="position:absolute; bottom:-18px; left:-15px;"> 
            {{$t('select_item')}}
          </small>
        </div>
        <div style="position:relative;">
          <mdb-input :label="('Тромбокрит')"  v-model="trombokrit" outline/>
          <small v-if="$v.trombokrit.$dirty  && !$v.trombokrit.required" class="invalid-text  pl-4" style="position:absolute; bottom:-18px; left:-15px;"> 
            {{$t('select_item')}}
          </small>
        </div>
        <div style="position:relative;">
          <mdb-input :label="('ALY%-%-с содер.атип-х.лимф-в')"  v-model="aly" outline/>
          <small v-if="$v.aly.$dirty  && !$v.aly.required" class="invalid-text  pl-4" style="position:absolute; bottom:-18px; left:-15px;"> 
            {{$t('select_item')}}
          </small>
        </div>
        <div style="position:relative;">
          <mdb-input :label="('LIC%-%-с содер.круп.незр-х.кл-к')"  v-model="lic" outline/>
          <small v-if="$v.lic.$dirty  && !$v.lic.required" class="invalid-text  pl-4" style="position:absolute; bottom:-18px; left:-15px;"> 
            {{$t('select_item')}}
          </small>
        </div>
        <div style="position:relative;">
          <mdb-input :label="('ALY#-Абс.кол-во.атип-х.лимф-в')"  v-model="aly_2" outline/>
          <small v-if="$v.aly_2.$dirty  && !$v.aly_2.required" class="invalid-text  pl-4" style="position:absolute; bottom:-18px; left:-15px;"> 
            {{$t('select_item')}}
          </small>
        </div>
        <div style="position:relative;">
          <mdb-input :label="('LIC#-Абс.кол-во.круп.незрел.кл-к')"  v-model="lic_2" outline/>
          <small v-if="$v.lic_2.$dirty  && !$v.lic_2.required" class="invalid-text  pl-4" style="position:absolute; bottom:-18px; left:-15px;"> 
            {{$t('select_item')}}
          </small>
        </div>
        <div style="position:relative;">
          <mdb-input :label="('Скорость оседания эритроцитов  ')"   v-model="skorst_osedaniy_eritrositov" outline/>
          <small v-if="$v.skorst_osedaniy_eritrositov.$dirty  && !$v.skorst_osedaniy_eritrositov.required" class="invalid-text  pl-4" style="position:absolute; bottom:-18px; left:-15px;"> 
            {{$t('select_item')}}
          </small>
        </div>
        <div style="position:relative;">
          <mdb-input  type="text" v-model="qon_ivish_begin_date_time" outline/>
          <small  class=" text-primary pl-4" style="position:absolute; top:-18px; left:-15px;"> 
            Қоннинг ивиш вақти бош.
          </small>
          <small v-if="$v.qon_ivish_begin_date_time.$dirty  && !$v.qon_ivish_begin_date_time.required" class="invalid-text  pl-4" style="position:absolute; bottom:-18px; left:-15px;"> 
            {{$t('select_item')}}
          </small>
        </div>
        <div style="position:relative;">
          <mdb-input  type="text" v-model="qon_ivish_end_date_time" outline/>
          <small  class=" text-primary pl-4" style="position:absolute; top:-18px; left:-15px;"> 
            Қоннинг ивиш вақти туг.
          </small>
          <small v-if="$v.qon_ivish_end_date_time.$dirty  && !$v.qon_ivish_end_date_time.required" class="invalid-text  pl-4" style="position:absolute; bottom:-18px; left:-15px;"> 
            {{$t('select_item')}}
          </small>
        </div>
...
export default {
  ...
  validations: {
      ...
      trobositi: {required},
      sredniy_obyom_trombositov: {required},
      shir_rasm_tromb_po_obyom: {required},
      trombokrit: {required},
      aly: {required},
      lic: {required},
      aly_2: {required},
      lic_2: {required},
      skorst_osedaniy_eritrositov: {required},
      qon_ivish_begin_date_time: {required},
      qon_ivish_end_date_time: {required},
    ...
    async send(){
      try{
        ...
        if(data.id){
          ...
          this.loading = false;
          this.$refs.message.success('Added_successfully')
          this.$router.push('/um_qon_print/' + data.id)
