<template>
  <div class="bg-white"  style="min-height: 100vh; border-radius:3px;">
    <div class="border-bottom d-flex justify-content-between">
      <router-link to="/opuxoloviya">
         <h5 class="m-0 ml-4 d-flex" style="padding: 16px 0px">
           ОПУХОЛЕВЫЕ МАРКЕРЫ</h5>
      </router-link>
      <div>
         <router-link to="/opuxoloviya_add/0">
...
export default {
  data(){
    return {
      ...
      m_product :{
        rows: [],
        columns: ['patient_name', 'device_name', 'name_1', 'created_date_time','creator_doctor_name'],
        col : []
      },
    }
  },
  ...
  methods: {
    ...
    async checklist (){
      ...
      for_edit(edit_data)
      {
        this.$router.push("/opuxoloviya_add/" + edit_data.id);
      },
