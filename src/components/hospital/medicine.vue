        ...
        <div class="container ">
          ...
          <mdb-row >
            <mdb-col class="col-12 col-sm-12 col-md-12 col-lg-12">
              ...
              <mdb-input v-model="price" style="margin-top: 33px;" size="sm" type="number"  :label="$t('price')" icon="dollar-sign" group validate error="wrong" success="right"/>
              <small  class="invalid-text pt-2"  v-if="$v.price.$dirty && !$v.price.required" >
                {{$t('name_invalid_text')}}
              </small>

              <mdb-input hidden  v-model="fp_name" style="margin-top: 33px;" size="sm" :label="$t('InputNameForPrint')" icon="tag" group type="text" validate error="wrong" success="right"/>

              <!-- <mdb-input v-model="qty" size="sm" style="margin-top: 33px;" :label="$t('Qty')" icon="" group type="text" validate error="wrong" success="right"/>
              <small  class="invalid-text pt-2"  v-if="$v.qty.$dirty && !$v.qty.required" >
                {{$t('name_invalid_text')}}
              </small> -->

              <mdb-input v-model="code" size="sm" style="margin-top: 33px;" :label="$t('code')" icon="" group type="text" validate error="wrong" success="right"/>
              ...
              <mdb-input v-model="mf_name" size="sm" style="margin-top: 33px;" :label="$t('manifacturerName')" icon="" group type="text" validate error="wrong" success="right"/>
              <mdb-input v-model="specs"  size="sm" style="margin-top: 33px;" :label="$t('specs')" icon="" group type="textarea"  validate error="wrong" success="right"/>
            </mdb-col>
            <!-- <mdb-col class="col-12 col-sm-8 col-md-5 col-lg-5 p-4 mt-4">
              <div class="d-flex justify-content-center align-items-center"> 
                <div v-if="PicShow" class="user_img_test border shadow d-flex justify-content-center align-items-center">
                  ...
                  <h5 class="m-0 text-danger">No picture</h5>
                </div> 
                <div v-show="!PicShow" class="user_img " >
...
import {mapActions,mapGetters, mapMutations} from 'vuex'
  ...
  export default {
    ...
    methods : {
      ...mapActions(['fetch_m_Measure', 'fetch_m_product']),
